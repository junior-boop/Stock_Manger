...
function TacheCard({
    ...
    return (
        <div className="bg-white border border-slate-200 rounded-xl px-4 py-3 flex flex-col gap-2 group">
            ...
            {tache.description && (
                <p className="text-xs text-gray-500 line-clamp-2">{tache.description}</p>
            )}
            ...
            {tache.dateEcheance && (
                <div className="text-[10px] text-gray-400">{formatDate(tache.dateEcheance)}</div>
            )}
        </div>
    );
}
